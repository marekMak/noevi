      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 px-10 md:px-20 lg:px-40 pt-10">
        ...
        <div className="w-full h-[60vh] lg:h-fit py-5 px-4 md:px-0 relative">
          ...
          <div className="absolute cursor-pointer top-4 md:top-0 left-4 md:left-10 w-[60vh] h-[60vh] z-10 hover:z-50 duration-300">
            ...
            <div className="absolute bottom-16 md:bottom-24 -left-4 inline-block w-10 h-10 z-50 border-solid border-t-[136px] border-r-0 border-l-[136px] border-b-0 border-greeno border-r-transparent border-t-transparent border-b-transparent"></div>
          </div>
          ...
          <div className="absolute cursor-pointer top-28 md:top-20 left-40 md:left-60 w-[60vh] h-[60vh] z-20 hover:z-60 duration-300">
            ...
            <div className="absolute bottom-16 md:bottom-24 -right-4 inline-block w-10 h-10 border-solid border-t-0 border-r-0 border-l-[136px] border-b-[136px] border-l-transparent border-r-transparent border-t-transparent border-greeno"></div>
          </div>
        </div>
      </div>
